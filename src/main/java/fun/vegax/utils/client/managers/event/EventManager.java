package fun.vegax.utils.client.managers.event;

import net.minecraft.text.Text;
import net.minecraft.util.Formatting;
import fun.vegax.utils.client.managers.event.events.Event;
import fun.vegax.utils.client.managers.event.events.EventStoppable;
import fun.vegax.utils.client.managers.event.types.Priority;
import fun.vegax.common.logger.implement.ConsoleLogger;
import fun.vegax.common.logger.implement.MinecraftLogger;
import fun.vegax.features.module.exception.ModuleException;
