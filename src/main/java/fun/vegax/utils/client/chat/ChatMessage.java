package fun.vegax.utils.client.chat;
...
import fun.vegax.utils.client.text.TextHelper;

public class ChatMessage {
    public static MutableText brandmessage() {
        return (MutableText) TextHelper.applyPredefinedGradient("CodeDLC", "black_light_purple", true);
    }
    ...
    public static void brandmessage(String message) {
        if (MinecraftClient.getInstance().player != null) {
            Text prefix = TextHelper.applyPredefinedGradient("CodeDLC -> ", "black_light_purple", true);
