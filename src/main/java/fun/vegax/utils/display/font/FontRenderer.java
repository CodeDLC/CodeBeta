...
import fun.vegax.utils.display.font.entry.DrawEntry;
import fun.vegax.utils.display.font.glyph.Glyph;
import fun.vegax.utils.display.font.glyph.GlyphMap;
...
public class FontRenderer implements QuickImports {
    ...
    public static @NotNull Identifier randomIdentifier() {
        return Identifier.of("vegaxdlc", "temp/" + StringHelper.randomString(32));
    }
