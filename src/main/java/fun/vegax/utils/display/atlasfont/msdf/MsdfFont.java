package fun.vegax.utils.display.atlasfont.msdf;
...
import fun.vegax.utils.display.atlasfont.msdf.FontData.AtlasData;
import fun.vegax.utils.display.atlasfont.msdf.FontData.MetricsData;
