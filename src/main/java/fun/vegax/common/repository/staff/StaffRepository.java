package fun.vegax.common.repository.staff;

import fun.vegax.VegaXDLC;
import fun.vegax.utils.client.managers.file.FileController;
import fun.vegax.utils.client.managers.file.impl.StaffFile;
...
public class StaffRepository {
    ...
    private static void save() {
        FileController fileController = VegaXDLC.getInstance().getFileController();
