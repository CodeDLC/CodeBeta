package fun.vegax.display.screens.clickgui.components.implement.panels;

import fun.vegax.VegaXDLC;
import fun.vegax.display.screens.clickgui.components.AbstractComponent;
import fun.vegax.display.screens.clickgui.components.implement.module.PanelsModuleComponent;
...
public class CategoryPanelComponent extends AbstractComponent {
    ...
    public CategoryPanelComponent(ModuleCategory category) {
        ...
        List<Module> all = VegaXDLC.getInstance().getModuleRepository().modules();
        for (Module m : all) {
