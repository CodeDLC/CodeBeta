package fun.vegax.display.screens.clickgui.components.implement.autobuy.window;
...
import fun.vegax.display.screens.clickgui.components.implement.autobuy.settings.AutoBuySettingsComponent;
