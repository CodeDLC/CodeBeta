package fun.vegax.display.screens.clickgui.components.implement.category;
...
import fun.vegax.common.animation.implement.InOutBack;
import fun.vegax.utils.display.font.Fonts;
import fun.vegax.utils.display.shape.ShapeProperties;
import fun.vegax.display.screens.clickgui.components.implement.module.ModuleComponent;
...
public class CategoryComponent extends AbstractComponent {
    ...
    private void initializeModules() {
        List<Module> modules = VegaXDLC.getInstance()
                .getModuleRepository()
                .modules();
