package fun.vegax.display.screens.clickgui.newgui;

import fun.vegax.VegaXDLC;
import fun.vegax.display.screens.clickgui.newgui.animation.Animation;
import fun.vegax.display.screens.clickgui.newgui.animation.Easing;
import fun.vegax.display.screens.clickgui.newgui.elements.AbstractMenuElement;
import fun.vegax.display.screens.clickgui.newgui.elements.MenuModuleElement;
import fun.vegax.display.screens.clickgui.newgui.panels.HeaderPanel;
import fun.vegax.display.screens.clickgui.newgui.panels.SidebarPanel;
import fun.vegax.display.screens.clickgui.newgui.theme.Theme;
import fun.vegax.display.screens.clickgui.newgui.theme.ThemeManager;
import fun.vegax.display.screens.clickgui.newgui.utils.MathUtil;
import fun.vegax.display.screens.clickgui.newgui.utils.ScrollHandler;
...
import java.util.*;
import static fun.vegax.utils.display.interfaces.QuickImports.blur;
...
public class NewMenuScreen extends Screen {
    ...
    public void initialize() {
        modules.clear();
        modules.addAll(VegaXDLC.getInstance().getModuleRepository().modules().stream()
