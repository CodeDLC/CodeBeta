...
import fun.vegax.display.screens.clickgui.components.implement.other.SettingComponent;
import net.minecraft.client.gui.DrawContext;

import fun.vegax.features.module.setting.implement.GroupSetting;
import fun.vegax.utils.display.font.Fonts;
import fun.vegax.display.screens.clickgui.components.implement.window.AbstractWindow;
import fun.vegax.display.screens.clickgui.components.implement.window.implement.settings.group.GroupWindow;
import fun.vegax.display.screens.clickgui.components.implement.other.CheckComponent;
