package fun.vegax.display.screens.clickgui.components.implement.module;

import com.google.common.base.Suppliers;
import fun.vegax.VegaXDLC;
import fun.vegax.common.animation.Animation;
import fun.vegax.common.animation.implement.Decelerate;
import fun.vegax.display.screens.clickgui.components.AbstractComponent;
import fun.vegax.display.screens.clickgui.components.implement.settings.AbstractSettingComponent;
import fun.vegax.display.screens.clickgui.components.implement.settings.BindComponent;
import fun.vegax.display.screens.clickgui.components.implement.settings.CheckboxComponent;
import fun.vegax.display.screens.clickgui.components.implement.settings.ColorComponent;
import fun.vegax.display.screens.clickgui.components.implement.settings.GroupComponent;
import fun.vegax.display.screens.clickgui.components.implement.settings.SButtonComponent;
import fun.vegax.display.screens.clickgui.components.implement.settings.SliderComponent;
import fun.vegax.display.screens.clickgui.components.implement.settings.TextComponent;
import fun.vegax.display.screens.clickgui.components.implement.settings.multiselect.MultiSelectComponent;
import fun.vegax.display.screens.clickgui.components.implement.settings.select.SelectComponent;
import fun.vegax.features.module.Module;
import fun.vegax.features.module.setting.SettingComponentAdder;
import fun.vegax.utils.client.chat.StringHelper;
import fun.vegax.utils.display.atlasfont.msdf.MsdfFont;
...
import fun.vegax.utils.display.systemrender.builders.Builder;
...
import static fun.vegax.utils.display.font.Fonts.Type.DEFAULT;
...
public class PanelsModuleComponent extends AbstractComponent {
    ...
    public PanelsModuleComponent(Module module) {
        ...
        expandAnimation.setDirection(fun.vegax.common.animation.Direction.BACKWARDS);
        expandAnimation.reset();

        hoverAnimation.setDirection(fun.vegax.common.animation.Direction.BACKWARDS);
    ...
    private float getAnimatedHeight() {
        ...
        expandAnimation.setDirection(anyExpanded ? fun.vegax.common.animation.Direction.FORWARDS : fun.vegax.common.animation.Direction.BACKWARDS);
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        hoverAnimation.setDirection(hovered ? fun.vegax.common.animation.Direction.FORWARDS : fun.vegax.common.animation.Direction.BACKWARDS);
