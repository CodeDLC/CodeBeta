...
import fun.vegax.utils.display.glow.GlowEffect;
...
public class StaffList extends AbstractDraggable {
    ...
    public void drawDraggable(DrawContext context) {
        ...
        FontRenderer icon = Fonts.getSize(19, Fonts.Type.ICONVegaXDLCREG);
        FontRenderer items = Fonts.getSize(12, Fonts.Type.ICONVegaXDLCREG);
