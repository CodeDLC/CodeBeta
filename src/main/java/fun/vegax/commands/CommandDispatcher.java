...
import fun.vegax.utils.client.managers.api.command.exception.CommandNotFoundException;
...
import fun.vegax.events.chat.ChatEvent;
import fun.vegax.events.chat.TabCompleteEvent;
import fun.vegax.utils.display.interfaces.QuickLogger;
import fun.vegax.commands.argument.ArgConsumer;
import fun.vegax.commands.argument.CommandArguments;
...
public class CommandDispatcher implements QuickLogger {
    ...
    public CommandDispatcher(EventManager eventManager) {
        this.manager = VegaXDLC.getInstance().getCommandRepository();
