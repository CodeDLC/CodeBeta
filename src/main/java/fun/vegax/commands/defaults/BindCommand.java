...
import fun.vegax.utils.client.managers.api.command.datatypes.KeyDataType;
import fun.vegax.utils.client.managers.api.command.datatypes.ModuleDataType;
...
public class BindCommand extends Command {
    ...
    public BindCommand(VegaXDLC main) {
        super("bind");
