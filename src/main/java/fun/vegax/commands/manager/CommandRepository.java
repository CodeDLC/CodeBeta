package fun.vegax.commands.manager;
...
import fun.vegax.utils.client.managers.api.command.exception.CommandUnhandledException;
import fun.vegax.utils.client.managers.api.command.exception.ICommandException;
...
import fun.vegax.utils.client.managers.api.command.registry.Registry;
import fun.vegax.commands.argument.ArgConsumer;
import fun.vegax.commands.argument.CommandArguments;
import fun.vegax.commands.defaults.DefaultCommands;
    ...
    public Stream<String> tabComplete(String prefix) {
        ...
        if (args.isEmpty()) {
            return new TabCompleteHelper()
                    .addCommands(VegaXDLC.getInstance().getCommandRepository())
                    .filterPrefix(label)
                    .stream();
        } else {
