...
package fun.vegax.commands.argument;
...
import fun.vegax.utils.client.managers.api.command.datatypes.IDatatype;
import fun.vegax.utils.client.managers.api.command.datatypes.IDatatypeContext;
import fun.vegax.utils.client.managers.api.command.datatypes.IDatatypeFor;
import fun.vegax.utils.client.managers.api.command.datatypes.IDatatypePost;
import fun.vegax.utils.client.managers.api.command.exception.CommandException;
import fun.vegax.utils.client.managers.api.command.exception.CommandInvalidTypeException;
import fun.vegax.utils.client.managers.api.command.exception.CommandNotEnoughArgumentsException;
import fun.vegax.utils.client.managers.api.command.exception.CommandTooManyArgumentsException;
import fun.vegax.utils.client.managers.api.command.manager.ICommandManager;
