...
package fun.vegax.commands.argparser;

import fun.vegax.utils.client.managers.api.command.argparser.IArgParser;
...
import fun.vegax.utils.client.managers.api.command.exception.CommandNoParserForTypeException;
