...
import fun.vegax.common.repository.friend.Friend;
...
import fun.vegax.utils.features.aura.warp.TurnsConstructor;
    ...
    public void onRotationUpdate(RotationUpdateEvent e) {
        ...
        if (currentTarget != null) {
            ...
            TurnsConnection.INSTANCE.rotateTo(
                    new Turns(yaw, pitch),
                    TurnsConfig.DEFAULT,
                    fun.vegax.utils.math.task.TaskPriority.HIGH_IMPORTANCE_1,
                    this
            );
        }
    }
