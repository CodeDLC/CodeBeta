...
import fun.vegax.utils.interactions.inv.InventoryResult;
...
public class ElytraHelper extends Module {
    ...
    private void executeDefaultSwap() {
        ...
        if (slot != null) {
            ...
            if (fun.vegax.features.impl.render.Hud.getInstance().notificationSettings.isSelected("Элитра свап")) {
                String itemName = elytra ? "Элитры" : "Броня";
                fun.vegax.display.hud.Notifications.getInstance()
